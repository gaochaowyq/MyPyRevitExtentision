...
if __name__ == "__main__":
    Main(['/main:F:\Autodesk\MyPyRevitExtentision\TenElephant.extension\TenElephant.tab\TenElephant.panel\ZhangRan.pulldown\LastCreatedElement.pushbutton\script(bake).py',
          '/target:dll','/platform:x64'])
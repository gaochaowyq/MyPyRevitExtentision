...
@rpw.db.Transaction.ensure('_CreateWall')
def CreateWall(Curves,FamilySymbol, BaseLevel,TopLevel):
	for i in Curves:
		print(i)
		try:
			_Wall=DB.Wall.Create(doc,i,BaseLevel.Id, False)
		except:
			pass
...
try:
	c = CreateWall(Curve, FamilyName, Level, StructuralType)
	print(c)
except:
	pass
